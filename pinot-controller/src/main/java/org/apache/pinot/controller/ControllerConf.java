...
public class ControllerConf extends PinotConfiguration {
  ...
  private static final String DISK_UTILIZATION_THRESHOLD = "controller.disk.utilization.threshold";
  ...
  private static final long DEFAULT_RESOURCE_UTILIZATION_CHECKER_INITIAL_DELAY = 600L; // 10 minutes
